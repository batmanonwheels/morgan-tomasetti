	...
	return (
		<main className='col-span-full row-span-7 grid grid-cols-subgrid grid-rows-subgrid p-4'>
			<ViewTransition name={'cover-text'}>
				<section className='col-start-3 col-span-4 row-span-full my-auto flex flex-col gap-4'>
					<div className='flex flex-col'>
						<h1 className='text-6xl font-[--font-zenitha-classic]'>CONTACT</h1>
					...
					<div className='flex gap-2 flex-col w-1/2'>
						<h3 className='text-base font-bold font-mono'>SOCIALS</h3>
					...
					<div className='flex gap-2 flex-col w-full'>
						<h3 className='text-base font-bold font-mono'>REPRESENTATION</h3>
						<div className='flex flex-col h-5 w-full justify-evenly gap-1'>
			...
			<ViewTransition name={'cover-photo'}>
				<Image
					...
					width={width}
					height={height}
					className='col-start-6 col-span-full row-span-full w-full h-full object-cover rounded-lg object-top'
				/>
			</ViewTransition>
		</main>
	);
