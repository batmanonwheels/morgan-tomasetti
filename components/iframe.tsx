...
export default function Iframe({
	...
	if (thumbnailUrl)
		return (
			<div className="">
				{!isActive ? (
					<div className="aspect-video m-auto rounded-lg bg-black object-cover relative min-w-0 min-h-0 h-full w-auto">
						<Image
							width={1920}
							height={1080}
							src={thumbnailUrl}
						...
						<svg
							...
							viewBox="0 0 640 640"
							className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 fill-background h-1/4 w-1/4"
						>
