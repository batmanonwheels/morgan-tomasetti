...
export const ProjectList = ({
	...
	return (
		<aside className="flex h-10 w-full flex-col items-center gap-4 p-2 lg:h-auto lg:min-w-1/6 lg:basis-1/6 lg:items-start">
			...
			<ul className="no-scrollbar flex h-full max-w-full grow snap-x snap-mandatory flex-row gap-0 overflow-x-scroll px-36 italic text-xs lg:text-sm lg:snap-none lg:flex-col lg:gap-2 lg:overflow-hidden lg:px-0 lg:pl-2">
